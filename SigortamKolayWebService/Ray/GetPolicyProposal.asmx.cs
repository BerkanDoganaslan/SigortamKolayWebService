...
namespace SigortamKolayWebServiceRay
{
    ...
    public class GetPolicyProposal : System.Web.Services.WebService
    {
        ...
        public output GetProposal(input value)
        {
            ...
            try
            {
                ...
                //Ray sigorta şirketi için tanım varlığı kontrolü yapılıyor.
                ...
                returnValue.clause = System.IO.File.ReadAllText(@"C:\inetpub\wwwroot\SigortamKolayWebService\Ray\Clause.txt");
