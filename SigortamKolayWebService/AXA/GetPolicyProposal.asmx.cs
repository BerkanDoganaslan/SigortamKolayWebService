...
namespace SigortamKolayWebServiceAXA
{
    ...
    public class GetPolicyProposal : System.Web.Services.WebService
    {
        ...
        public output GetProposal(input value)
        {
            ...
            try
            {
                ...
                //AXA sigorta şirketi için tanım varlığı kontrolü yapılıyor.
                ...
                returnValue.clause = System.IO.File.ReadAllText(@"C:\inetpub\wwwroot\SigortamKolayWebService\AXA\Clause.txt");
            ...
            //Hata mesajını soap ex tipinde dönüş yapılan hata yakalama bloğu
            catch (Exception ex)
            {
        ...
        //Veri tabanı tanım tabloları sorgulama işlemleri için oluşturulan connection
        ...
        //Veri tabanı kayıt işlemleri yapılan connection
