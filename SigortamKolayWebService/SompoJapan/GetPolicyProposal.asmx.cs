...
namespace SigortamKolayWebServiceSompoJapan
{
    ...
    public class GetPolicyProposal : System.Web.Services.WebService
    {
        ...
        public output GetProposal(input value)
        {
            ...
            try
            {
                ...
                //Sompo Japan sigorta şirketi için tanım varlığı kontrolü yapılıyor.
                ...
                returnValue.clause = System.IO.File.ReadAllText(@"C:\inetpub\wwwroot\SigortamKolayWebService\SompoJapan\Clause.txt");
