...
namespace SigortamKolayWebServiceGenerali
{
    ...
    public class GetPolicyProposal : System.Web.Services.WebService
    {
        ...
        public output GetProposal(input value)
        {
            ...
            try
            {
                ...
                //Generali sigorta şirketi için tanım varlığı kontrolü yapılıyor.
                ...
                returnValue.clause = System.IO.File.ReadAllText(@"C:\inetpub\wwwroot\SigortamKolayWebService\Generali\Clause.txt");
